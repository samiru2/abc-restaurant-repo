...
public class SalesReportUtility {

    public static void generateSalesReportPdf(List<Order> orders, OutputStream outputStream) throws DocumentException, IOException {
